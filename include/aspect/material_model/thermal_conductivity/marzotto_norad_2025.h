...
#ifndef _aspect_material_model_thermal_conductivity_marzotto_norad_2025_h
#define _aspect_material_model_thermal_conductivity_marzotto_norad_2025_h
...
namespace aspect
{
  namespace MaterialModel
  {
    namespace ThermalConductivity
    {
      ...
      * using the Marzotto et al. (2025) formulation without radiative contribution
      ...
      */
      ...
      template <int dim>
      class marzotto_norad_2025 : public Interface<dim>
      {
        public:
          /**
