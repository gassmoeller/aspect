...
#ifndef _aspect_material_model_rheology_grain_size_diffusion_dislocation_h
#define _aspect_material_model_rheology_grain_size_diffusion_dislocation_h
...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    {
      /**
       * A rheology model that relies on compositional fields that stand for
       ...
       */
      template <int dim>
      class GrainSizeDiffusionDislocation : public ::aspect::SimulatorAccess<dim>
      {
        public:
