...
#ifndef _aspect_postprocess_visualization_unit_coordinates_h
#define _aspect_postprocess_visualization_unit_coordinates_h
...
namespace aspect
{
  namespace Postprocess
  {
    namespace VisualizationPostprocessors
    {
       ...
       * and computes a variable that represents the unit coordinates of each
       * vertex.
       *
