...
#ifndef _aspect_particle_interpolator_moving_average_h
#define _aspect_particle_interpolator_moving_average_h
...
namespace aspect
{
  namespace Particle
  {
    ...
    {
      /**
       * Return the moving average of particles weighted by distance.
       *
       * @ingroup ParticleInterpolators
       */
      template <int dim>
      class MovingAverage : public Interface<dim>, public aspect::SimulatorAccess<dim>
      {
        public:
          /**
           * Return the distance-weighted averaged properties of all particles within interpolation distance of the
           * given positions.
           */
        ...
        private:
          ...
          std::unique_ptr<GridTools::Cache<dim>> triangulation_cache;
      };
    }
  }
}
