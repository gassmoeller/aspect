...
#ifndef _aspect_particle_property_temperature_h
#define _aspect_particle_property_temperature_h
...
namespace aspect
{
  namespace Particle
  {
    namespace Property
    {
       ...
       */
      template <int dim>
      class Temperature : public Interface<dim>, public ::aspect::SimulatorAccess<dim>
      {
        public:
          /**
