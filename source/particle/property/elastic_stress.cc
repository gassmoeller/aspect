  ...
  namespace Particle
  {
    namespace Property
    {
      ASPECT_REGISTER_PARTICLE_PROPERTY(ElasticStress,
                                        ...
                                        "with the name ve_stress_*. It first applies the update "
                                        "of the stresses of the previous computational timestep, "
                                        "and then the rotation of those stresses into the current "
                                        "timestep. "
