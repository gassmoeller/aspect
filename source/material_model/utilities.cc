    ...
    namespace MaterialUtilities
    {
      ...
      PhaseFunction<dim>::declare_parameters (ParameterHandler &prm)
      {
        ...
        prm.declare_entry ("Phase transition temperature upper limits",
                           ...
                           "List must have the same number of entries as Phase transition depths. "
                           "When the options of temperature limits are adapted, the user has to be "
                           "careful about the consistency between adjacent phases to make perfect "
                           "sense in their physics. We recommend producing a phase diagram with "
                           "simple model setups to check the implementation as a starting point."
                           "Units: \\si{\\kelvin}.");
        prm.declare_entry ("Phase transition temperature lower limits", "0.0",
                           Patterns::Anything(),
