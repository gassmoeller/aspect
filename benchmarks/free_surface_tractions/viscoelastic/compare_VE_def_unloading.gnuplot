...
plot 'output_free_surface_VE_cylinder_2D_loading_unloading/statistics.dat' using (column("Time (years)")):(column("Minimum topography (m)")) title 'Numerical, no stress averaging' with linesp
