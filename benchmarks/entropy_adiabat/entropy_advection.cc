      ...
      for (unsigned int q=0; q<n_q_points; ++q)
        {
          ...
          const double conductivity =  scratch.material_model_outputs.thermal_conductivities[q] * scratch.material_model_inputs.temperature[q] /
...
// The function below replace the normal temperature advection assembler with the entropy advection assembler of this file
  template <int dim>
