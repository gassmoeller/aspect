...
#ifndef _aspect_material_model_melt_simple_volatile_h
#define _aspect_material_model_melt_simple_volatile_h
...
namespace aspect
{
  namespace MaterialModel
  {
     ...
     */
    template <int dim>
    class MeltSimpleVolatile : public MaterialModel::MeltInterface<dim>,
