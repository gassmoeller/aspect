...
#include </home/bbpdneu1/software/co2/aspect/melt_volatiles_plugins/melt_simple_volatiles.h>
...
namespace aspect
{
  namespace MaterialModel
  {
    ...
    template <int dim>
    void
    MeltSimpleVolatile<dim>::initialize ()
    {
    ...
    template <int dim>
    void
    MeltSimpleVolatile<dim>::declare_parameters (ParameterHandler &prm)
    {
    ...
    template <int dim>
    void
    MeltSimpleVolatile<dim>::parse_parameters (ParameterHandler &prm)
    {
      prm.enter_subsection("Material model");
      {
        prm.enter_subsection("Melt simple volatiles");
...
namespace aspect
{
  namespace MaterialModel
  {
    ASPECT_REGISTER_MATERIAL_MODEL(MeltSimpleVolatile,
                                   "melt simple volatiles",
